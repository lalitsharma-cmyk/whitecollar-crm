...
- ⏳ **NEXT:** UI polish pass (ActionButton/Lucide consistency, empty states, dark-mode audit across all HR pages) · settings/new-candidate page review · final per-role QA smoke on live. Tables: tsc 0 · hr-rbac PASS · regression 108/0 · next build OK on every batch.
