  ...
  return (
    <div className="space-y-4 max-w-3xl">
      <div>
        ...
        <h1 className="text-xl sm:text-2xl font-bold mt-1">Import Buyer Data</h1>
        <p className="text-xs sm:text-sm text-gray-500 dark:text-slate-400">
          Upload an Excel / CSV of property transactions. Map the columns once — every unmapped
          column is preserved verbatim. Transaction dates are read from the sheet (Excel serials &amp;
